"""
Shared utility functions for the analytics agent pipeline.

Engine-specific logic lives in source/engine.py.
Engine-specific logic lives in source/engine.py.
LLM configuration lives in source/llm/llm_config.py.
"""
...
# ═══════════════════════════════════════════════════════════════════════
# Module-level config cache is now handled by source.llm.factory
